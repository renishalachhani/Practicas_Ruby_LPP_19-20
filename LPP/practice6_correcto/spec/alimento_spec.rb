...
RSpec.describe Alimento do
	before :all do 
		...
		@a1 = Alimento.new("Carne de cordero", 18.0, 0.0, 17.0, 20.0, 185.0)
		@a2 = Alimento.new("Pollo", 20.6, 0.0, 5.6, 5.7, 7.1)
		@a3 = Alimento.new("Chocolate", 5.3, 47.0, 30.0, 2.3, 3.4)
		@a4 = Alimento.new("Huevos", 13.0, 1.1, 11.0, 4.2, 5.7)
		@a5 = Alimento.new("Carne de vaca", 21.1, 0.0, 3.1, 50.0, 164.4)
		@a6 = Alimento.new("Salmon", 19.9, 0.0, 13.6, 6.0, 3.7)
		@a7 = Alimento.new("Nuez", 20.0, 21.0, 54.0, 0.3, 7.9)
		@a8 = Alimento.new("Tofu", 8.0, 1.9, 4.8, 2.0, 2.2)
